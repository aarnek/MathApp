...
**
** Created: Mon Apr 11 09:31:09 2011
...
static const char qt_meta_stringdata_Graphics[] = {
    "Graphics\0\0drawGraph(QString)\0"
};

const QMetaObject Graphics::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_Graphics,
...
int Graphics::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: drawGraph((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
